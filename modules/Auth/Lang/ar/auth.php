...
return [
    ...
    'user_resource' => [
        ...
        'impersonate_confirmation' => 'ستقوم بتسجيل الدخول باسم هذا المستخدم ويمكنك العودة إلى حسابك في أي وقت.',
        'impersonating_banner' => 'أنت مسجل دخول باسم :name. جميع الإجراءات تُنسب إلى هذا الحساب.',
        'stop_impersonating' => 'العودة إلى حسابك',
        'reset_password' => 'إعادة تعيين كلمة المرور',
        'new_password' => 'كلمة المرور الجديدة',
        'activate' => 'تفعيل',
        'deactivate' => 'إلغاء التفعيل',
    ...
    // الأخطاء
    'errors' => [
        'cannot_delete_system_role' => 'لا يمكن حذف أدوار النظام أو دور المسؤول الأعلى.',
    ],
];
