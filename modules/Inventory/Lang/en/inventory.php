...
return [
    ...
    'sections' => [
        ...
        'accounting_description' => 'Configure accounting accounts for products in this category. Products inherit these settings if not configured individually.',
    ...
    'fields' => [
        ...
        'stock_input_account_help' => 'Account credited when stock increases (gains)',
        'stock_output_account' => 'Stock Output Account',
        'stock_output_account_help' => 'Account debited when stock decreases (losses/COGS)',
    ...
    'messages' => [
        ...
        'bill_reset_to_draft' => 'Bill reset to draft successfully',
        'bill_reset_failed' => 'Failed to reset bill to draft',
        'reset_bill_to_draft_confirmation' => 'This will reset the bill to draft and delete the associated journal entry. Continue?',
    ...
    'stock_report' => [
        ...
        'show_zero_stock' => 'Zero Stock',
        'hide_zero' => 'Hide zero stock',
        'show_all' => 'Show all',
        'only_zero' => 'Only zero stock',
        'view_movements' => 'View Movements',
        'movements_for' => 'Stock Movements for :product',
        ...
        'reference' => 'Reference',
        'user' => 'User',
        'showing_latest' => 'Showing latest :count movements',
