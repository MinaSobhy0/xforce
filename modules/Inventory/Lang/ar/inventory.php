...
return [
    ...
    'sections' => [
        ...
        'accounting' => 'المحاسبة',
        'accounting_description' => 'إعداد الحسابات المحاسبية للمنتجات في هذه الفئة. ترث المنتجات هذه الإعدادات إذا لم يتم تكوينها بشكل فردي.',
    ...
    'fields' => [
        ...
        'stock_input_account_help' => 'الحساب الدائن عند زيادة المخزون',
        'stock_output_account' => 'حساب إخراج المخزون',
        'stock_output_account_help' => 'الحساب المدين عند نقص المخزون',
