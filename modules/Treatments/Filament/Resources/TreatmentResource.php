...
namespace Modules\Treatments\Filament\Resources;
...
class TreatmentResource extends Resource
{
    ...
    {
        return __('treatments::treatments.navigation.treatments');
    }

    public static function getModelLabel(): string
    {
        return __('treatments::treatments.labels.treatment');
    }

    public static function getPluralModelLabel(): string
    {
        return __('treatments::treatments.labels.treatments');
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Tabs::make('Treatment')
                    ->tabs([
                                ...
                                Forms\Components\Grid::make(3)
                                    ->schema([
                                        ...
                                        Forms\Components\Select::make('category_id')
                                            ->label(__('treatments::treatments.fields.category'))
                                            ->relationship('category', 'id')
                                            ->getOptionLabelFromRecordUsing(fn (TreatmentCategory $record) => $record->full_path)
                                            ->searchable()
                                            ->preload()
                                            ->required(),

                                        Forms\Components\Toggle::make('is_active')
                                            ->label(__('treatments::treatments.fields.is_active'))
                                            ->default(true),
                                    ]),
                                        ...
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\TextInput::make('name.en')
                                                    ->label(__('treatments::treatments.fields.name') . ' (English)')
                                                    ->required()
                                                    ->maxLength(150),

                                                Forms\Components\TextInput::make('name.ar')
                                                    ->label(__('treatments::treatments.fields.name') . ' (Arabic)')
                                                    ->required()
                                                    ->maxLength(150),
                                            ]),
                                        ...
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\RichEditor::make('description.en')
                                                    ->label(__('treatments::treatments.fields.description') . ' (English)')
                                                    ->toolbarButtons(['bold', 'italic', 'bulletList', 'orderedList']),

                                                Forms\Components\RichEditor::make('description.ar')
                                                    ->label(__('treatments::treatments.fields.description') . ' (Arabic)')
                                                    ->toolbarButtons(['bold', 'italic', 'bulletList', 'orderedList']),
                                            ]),
                                    ]),
                                        ...
                                        Forms\Components\Grid::make(4)
                                            ->schema([
                                                Forms\Components\TextInput::make('duration_minutes')
                                                    ->label(__('treatments::treatments.fields.duration'))
                                                    ->numeric()
                                                    ->required()
                                                    ->default(30)
                                                    ->suffix('min'),
                                                ...
                                                Forms\Components\TextInput::make('buffer_minutes')
                                                    ->label(__('treatments::treatments.fields.buffer_time'))
                                                    ->numeric()
                                                    ->default(0)
                                                    ->suffix('min'),

                                                Forms\Components\TextInput::make('base_price_minor')
                                                    ->label(__('treatments::treatments.fields.base_price'))
                                                    ->numeric()
                                                    ->required()
                                                    ->default(0)
                                                    ->suffix('piasters')
                                        ...
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\TextInput::make('recommended_sessions')
                                                    ->label(__('treatments::treatments.fields.recommended_sessions'))
                                                    ->numeric()
                                                    ->nullable(),

                                                Forms\Components\TextInput::make('session_interval_days')
                                                    ->label(__('treatments::treatments.fields.session_interval_days'))
                                                    ->numeric()
                                                    ->nullable()
                                                    ->suffix('days'),
                                            ]),
                                        ...
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\Select::make('fitzpatrick_min')
                                                    ->label(__('treatments::treatments.fields.fitzpatrick_min'))
                                                    ->options([
                                                        1 => 'Type I - Very fair',
                                                        2 => 'Type II - Fair',
                                                        3 => 'Type III - Medium',
                                                ...
                                                Forms\Components\Select::make('fitzpatrick_max')
                                                    ->label(__('treatments::treatments.fields.fitzpatrick_max'))
                                                    ->options([
                                                        1 => 'Type I - Very fair',
                                                        2 => 'Type II - Fair',
                                                        3 => 'Type III - Medium',
                                ...
                                Forms\Components\Section::make('Contraindications')
                                    ->schema([
                                        Forms\Components\CheckboxList::make('contraindications')
                                            ->label(__('treatments::treatments.fields.contraindications'))
                                            ->options([
                                                'pregnancy' => 'Pregnancy',
                                ...
                                Forms\Components\Section::make('Consent Requirements')
                                    ->schema([
                                        Forms\Components\Toggle::make('requires_consent')
                                            ->label(__('treatments::treatments.fields.requires_consent'))
                                            ->reactive(),

                                        Forms\Components\Select::make('consent_template_id')
                                            ->label(__('treatments::treatments.fields.consent_template'))
                        ...
                        Forms\Components\Tabs\Tab::make('Care Instructions')
                            ->schema([
                                Forms\Components\Section::make('Pre-Treatment Instructions')
                                    ->schema([
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\RichEditor::make('pre_care_instructions.en')
                                                    ->label(__('treatments::treatments.fields.pre_care') . ' (English)')
                                                    ->toolbarButtons(['bold', 'italic', 'bulletList', 'orderedList']),

                                                Forms\Components\RichEditor::make('pre_care_instructions.ar')
                                                    ->label(__('treatments::treatments.fields.pre_care') . ' (Arabic)')
                                                    ->toolbarButtons(['bold', 'italic', 'bulletList', 'orderedList']),
                                            ]),
                                    ]),

                                Forms\Components\Section::make('Post-Treatment Instructions')
                                    ->schema([
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\RichEditor::make('post_care_instructions.en')
                                                    ->label(__('treatments::treatments.fields.post_care') . ' (English)')
                                                    ->toolbarButtons(['bold', 'italic', 'bulletList', 'orderedList']),

                                                Forms\Components\RichEditor::make('post_care_instructions.ar')
                                                    ->label(__('treatments::treatments.fields.post_care') . ' (Arabic)')
                                                    ->toolbarButtons(['bold', 'italic', 'bulletList', 'orderedList']),
                                            ]),
                                    ]),
                            ]),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('translated_name')
                    ->label(__('treatments::treatments.fields.name'))
                    ->searchable(['name'])
                    ->sortable()
                    ->wrap(),
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('category_id')
                    ->label(__('treatments::treatments.fields.category'))
                    ->relationship('category', 'id')
                    ->getOptionLabelFromRecordUsing(fn (TreatmentCategory $record) => $record->translated_name)
                    ->searchable()
                    ->preload(),
