...
return [
    ...
    'balance_brought_forward' => 'رصيد مرحل من الفترة السابقة',
    ...
    'no_transactions_on_date' => 'لا توجد معاملات في هذا التاريخ',
    ...
    'entry_mode' => 'نوع القيد',
    'with_partner' => 'مع طرف',
    'with_account' => 'حساب مقابل',
    'select_partner' => 'اختر الطرف...',
    'will_credit_receivable' => 'سيتم إضافة للذمم المدينة (استلام من عميل)',
    'will_debit_receivable' => 'سيتم خصم من الذمم المدينة (رد للعميل)',
    'will_credit_payable' => 'سيتم إضافة للذمم الدائنة (رد من مورد)',
    'will_debit_payable' => 'سيتم خصم من الذمم الدائنة (دفع لمورد)',
    'skip' => 'تخطي',
    'cash_voucher' => 'سند قبض/صرف',
    'voucher_no' => 'رقم السند',
    'received_by' => 'المستلم',
    'paid_to' => 'مدفوع إلى',
    'received_from' => 'مستلم من',
    'transfer' => 'تحويل',
    'destination_journal' => 'اليومية الوجهة',
    'transfer_description_placeholder' => 'مثال: إيداع يومي بالبنك',
    'transfer_between_accounts' => 'تحويل بين الحسابات',
    'close_cash' => 'إغلاق الصندوق',
    'close_cash_hint' => 'تحويل الرصيد الكامل لإغلاق الصندوق',
    'closing_balance_ref' => 'رصيد الإغلاق :date',

    'voucher_types' => [
        'customer_payment' => 'تحصيل من عميل',
        'customer_refund' => 'رد لعميل',
        'supplier_payment' => 'دفع لمورد',
        'supplier_refund' => 'استرداد من مورد',
        'staff_advance' => 'سلفة موظف',
        'staff_repayment' => 'سداد من موظف',
    ],
    ...
    'messages' => [
        ...
        'select_journal_first' => 'يرجى اختيار يومية أولاً',
        'select_journal_hint' => 'اختر يومية نقدية أو بنكية من القائمة أعلاه لبدء تسجيل المعاملات.',
        'receivable_not_configured' => 'حساب الذمم المدينة غير مُعَد. يرجى إعداد الحسابات الافتراضية في الإعدادات.',
        'payable_not_configured' => 'حساب الذمم الدائنة غير مُعَد. يرجى إعداد الحسابات الافتراضية في الإعدادات.',
        'transaction_saved' => 'تم حفظ المعاملة بنجاح',
        'transaction_failed' => 'فشل حفظ المعاملة',
        'entry_code' => 'القيد: :code',
        'transfer_saved' => 'تم التحويل بنجاح',
        'transfer_failed' => 'فشل إتمام التحويل',
        'destination_account_not_configured' => 'اليومية الوجهة ليس لها حساب افتراضي',
    ],
];
