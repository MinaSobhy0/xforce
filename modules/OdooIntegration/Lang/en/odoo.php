...
return [
    ...
    'helpers' => [
        ...
        'delta_sync' => 'Only process records changed since the last sync',
    ...
    'messages' => [
        ...
        'push_bulk_body' => ':pushed pushed, :skipped skipped, :failed failed.',
        'push_skipped_reason' => 'Skipped record :id — :field (id :related_id) is not linked to Odoo yet; push that record first.',
