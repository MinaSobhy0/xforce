<x-filament-panels::page>
    ...
    <div class="flex gap-4 mb-6" style="width: fit-content;">
        {{-- New Sessions --}}
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 text-center w-32">
