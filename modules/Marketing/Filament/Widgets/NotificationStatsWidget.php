...
namespace Modules\Marketing\Filament\Widgets;
...
class NotificationStatsWidget extends BaseWidget
{
    ...
    public static function canView(): bool
    {
        ...
        return $user->can('campaigns.view') || !\Spatie\Permission\Models\Permission::where('name', 'campaigns.view')->where('guard_name', 'web')->exists();
    }
