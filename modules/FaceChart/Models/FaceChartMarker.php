...
class FaceChartMarker extends BaseModel
{
    ...
    protected $casts = [
        ...
        'depth_mm' => 'decimal:2',
        'arrow_end_x' => 'decimal:6',
        'arrow_end_y' => 'decimal:6',
    ...
    public function toMarkerData(): array
    {
        ...
        return [
            ...
            // Arrow endpoint for surface-following arrows
            'arrowEndX' => $this->arrow_end_x !== null ? (float) $this->arrow_end_x : null,
            'arrowEndY' => $this->arrow_end_y !== null ? (float) $this->arrow_end_y : null,
            'arrowEndZ' => $this->arrow_end_z !== null ? (float) $this->arrow_end_z : null,
            // Visual properties
