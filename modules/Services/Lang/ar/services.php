...
return [
    ...
    'helpers' => [
        'unearned_revenue_account' => 'تجاوز حساب الفئة. اتركه فارغًا لاستخدام الحساب الافتراضي للفئة.',
        'service_revenue_account' => 'تجاوز حساب الفئة. اتركه فارغًا لاستخدام الحساب الافتراضي للفئة.',
    ],
    ...
    'messages' => [
        ...
        'select_category_first' => 'اختر فئة لعرض الحسابات الافتراضية',
