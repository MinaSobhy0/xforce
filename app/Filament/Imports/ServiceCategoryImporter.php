...
class ServiceCategoryImporter extends BaseImporter
{
        ...
        return [
            ...
            ImportColumn::make('parent_name')
                ...
                ->fillRecordUsing(function ($record, $state) {
                    ...
                    $parent = ServiceCategory::where('tenant_id', $tenantId)
            ...
            ImportColumn::make('icon')
                ->label(__('core::import.fields.icon'))
                ->rules(['nullable', 'string', 'max:100']),

            ImportColumn::make('color')
                ->label(__('core::import.fields.color'))
