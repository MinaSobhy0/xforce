...
function createTenant(array $attributes = []): \Modules\Core\Models\Tenant
{
    return \Modules\Core\Models\Tenant::factory()->create($attributes);
}

function createUser(array $attributes = []): \Modules\Auth\Models\User
{
