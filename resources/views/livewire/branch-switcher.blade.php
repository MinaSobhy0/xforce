        ...
        <x-filament::dropdown placement="bottom-start" width="xs">
            ...
            <div class="p-2">
                ...
                <button
                    ...
                    class="flex items-center gap-2 w-full px-3 py-2 text-sm rounded-lg transition {{ empty($selectedBranchIds) ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/10 dark:text-primary-400' : 'hover:bg-gray-100 dark:hover:bg-white/5 text-gray-700 dark:text-gray-200' }}"
                >
                ...
                <div class="space-y-1 mt-1">
                    @foreach($branches as $branch)
                        ...
                        >
                            ...
                            @if($branch->is_main)
                                <span class="text-xs text-warning-500 dark:text-warning-400">(Main)</span>
                            @endif
                        </button>
                    @endforeach
                </div>
